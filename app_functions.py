...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        print("You rolled a {0} and a {1}... What is the {2} of {0} and {1}?".format(die_1_value, die_2_value, question_type))
    elif question_type == "difference":
        print("You rolled a {0} and a {1}... What is the {2} between {0} and {1}?".format(die_1_value, die_2_value, question_type))
...
def input_answer():
    ...
    if user_ans.isdigit() and len(user_ans) > 0:
        return int(user_ans)
    else:
        return -1
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    if question_type == "sum":
        ...
        if die_1_value - die_2_value < 0:
            ab_val = -(die_1_value - die_2_value)
        else:
            ab_val = die_1_value - die_2_value
            
        if given_answer == ab_val:
            return True
        else:
            return False
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        ...
        if die_1_value - die_2_value < 0:
            ...
            ab_val = die_1_value - die_2_value
        print(f"No! The difference between {die_1_value} and {die_2_value} is {ab_val}!")
